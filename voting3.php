...
<form method ="post" action="vote3.php">
	...
	<div class="governor">
		<div class="gov-margin">
			...
			<?php 
			$governor=mysqli_query($link,"select * from candidate where Position='Governor'")or die(mysqli_error());
...
<?php 
	$vice=mysqli_query($link,"select * from candidate where Position='Vice-Governor'")or die(mysqli_error());
...
<?php 
	$representative=mysqli_query($link,"select * from candidate where Position='3rd Year Representative'")or die(mysqli_error());
