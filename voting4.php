...
<div class="vice-align">
<div class="hero-body-candidate1">
<font color="white">Candidate for General Secretary</font>
</div>

<div class="governor">
<div class="gov-margin">
<?php 
$vice=mysqli_query($link,"select * from candidate where Position='General Secretary'")or die(mysqli_error());
while($row=mysqli_fetch_array($vice)){ $vice_id=$row['CandidateID']; ?>
...
<div class="vice-align">
<div class="hero-body-candidate1">
<font color="white">Candidate for Joint Secretary</font>
</div>

<div class="governor">
<div class="gov-margin">
<?php 
$vice=mysqli_query($link,"select * from candidate where Position='Joint Secretary'")or die(mysqli_error());
while($row=mysqli_fetch_array($vice)){ $vice_id=$row['CandidateID']; ?>
...
<div class="gov-margin">
<?php 
$vice=mysqli_query($link,"select * from candidate where Position='Treasurer'")or die(mysqli_error());
while($row=mysqli_fetch_array($vice)){ $vice_id=$row['CandidateID']; ?>
