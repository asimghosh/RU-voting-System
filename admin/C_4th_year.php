...
<div class="navbar">
    ...
    <li class="active"><a href="C_4th_year.php"><font color="white">Members</font></a></li>
...
<?php $candidate_query=mysqli_query($link,"select  * from candidate where Position='Members'");
