...
<div class="navbar">
	...
	<?php 
		$result=mysqli_query($link,"select * from candidate where CandidateID='$get_id'") or die(mysqli_error());
		$row=mysqli_fetch_array($result);
	?>
   ...
   <option><?php echo $row['Gender']; ?></option>
    ...
    <div class="controls">
   <select name="rdept" class="rdept" id="span2">
   ...
   <select name="rposition" class="rposition" id="span90">
	...
	<option>General Secretray</option>
...
<?php
	if (isset($_POST['save'])){
		...
		$image_size= getimagesize($_FILES['image']['tmp_name']);
			...
			mysqli_query($link,"update candidate set FirstName='$rfirstname',LastName='$rlastname',Gender='$rgender',Dept='$rdept',Position='$rposition',MiddleName='$rname',Party='$party',Photo='$location' where CandidateID='$get_id'")or die(mysqli_query);
			...
			mysqli_query($link,"INSERT INTO history (data,action,date,user)VALUES('$rfirstname $rlastname', 'Edit Candidate', NOW(),'$user_name')")or die(mysqli_error());
