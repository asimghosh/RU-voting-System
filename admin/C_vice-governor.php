...
<div class="navbar">
	...
	<?php
		$query=mysqli_query($link,"select  * from candidate where Position='Governor'");
...
<?php 
	$candidate_query=mysqli_query($link,"select  * from candidate where Position='Vice-Governor'");
