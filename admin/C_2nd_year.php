...
<div class="navbar">
	...
	<form class="navbar-form pull-right">
		...
		<?php $result=mysqli_query($link,"select * from users where User_id='$id_session'");
    ...
    <li class="active"><a href="C_2nd_year.php"><font color="white">Joint Secretary</font></a></li>
    <li><a href="C_3rd_year.php"><font color="white">Treasurer</font></a></li>
    <li><a href="C_4th_year.php"><font color="white">Members</font></a></li>
	...
	<?php
	$query=mysqli_query($link,"select  * from candidate");
...
<?php $candidate_query=mysqli_query($link,"select  * from candidate where Position='Joint Secretary'");
...
<tr class="del<?php echo $id ?>">
	...
	<td align="center"><img class="pic" width="40" height="30" src="<?php echo $candidate_rows['Photo'];?>" border="0" onmouseover="showtrail('<?php echo $candidate_rows['Photo'];?>','<?php echo $candidate_rows['FirstName']." ".$candidate_rows['LastName'];?> ',200,5)" onmouseout="hidetrail()"></a></td>
		<td align="center">
	<?php $votes_query=mysqli_query($link,"select * from votes where CandidateID='$id'");
