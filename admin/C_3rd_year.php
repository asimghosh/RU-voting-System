...
<div class="navbar">
    ...
    <li><a href="C_2nd_year.php"><font color="white">Joint Secretary</font></a></li>
    <li class="active"><a href="C_3rd_year.php"><font color="white">Treasurer</font></a></li>
...
<?php $candidate_query=mysqli_query($link,"select  * from candidate where Position='Treasurer'");
