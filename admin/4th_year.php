...
<div class="navbar">
    ...
    <li><a href="3rd_year.php"><font color="white">Treasurer</font></a></li>
    <li class="active"><a href="4th_year.php"><font color="white">Members</font></a></li>
...
<?php 
	$candidate_query=mysqli_query($link,"select  * from candidate where Position='Members'");
